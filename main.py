...
uploaded_file = st.file_uploader("Choose a X Ray Image", type="jpg")
...
#image = Image.open(img_name).convert('RGB')
    ...
    label = teachable_machine_classification(image, '/Users/fridaruh/Documents/Proyectos/Streamlit_2/converted_keras/keras_model.h5')
    if label == 1:
